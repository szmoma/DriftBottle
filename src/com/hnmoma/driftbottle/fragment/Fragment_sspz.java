 ...
 *
 */
public class Fragment_sspz extends BaseFragment implements OnClickListener{
	...
	public static BaseFragment newInstance(PickBottleModel model) {
		Fragment_sspz fragment = new Fragment_sspz();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(R.layout.fishing_sspz, container, false);
	}
