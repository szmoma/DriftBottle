...
public class RecorderVideoActivity extends BaseActivity implements OnClickListener, Callback, OnErrorListener, OnInfoListener {
	...
	private void handleSurfaceChanged() {
		...
		// 获取摄像头的所有支持的分辨率
		List<Camera.Size> resolutionList = AndroidVersionsUtils.getResolutionList(mCamera);
		if (resolutionList != null && resolutionList.size() > 0) {
			Collections.sort(resolutionList, new AndroidVersionsUtils.ResolutionComparator());
	...
	public void onClick(View view) {
		...
		case R.id.recorder_stop:
			...
			new AlertDialog.Builder(this).setMessage("是否发送？").setPositiveButton(R.string.confirm, new DialogInterface.OnClickListener() {
