 ...
 *
 */
public class Throw_sspz extends BaseActivity implements OnClickListener, OnGestureListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mEditEmojicon.setHint(getResources().getString(R.string.tip_hint_talk_bottle));
...
//					doSubmit();
			...
			case R.id.bt_pic:
				if(attachmentType==0 || attachmentType==1){
					...
					final BuyDialog dialogToBuy = new BuyDialog(Throw_sspz.this, R.style.style_dialog_ballon, "确定");
					dialogToBuy.show();
					dialogToBuy.setContent(null, "已添加语音附件，是否移除该语音添加图片附件？");
			...
			case R.id.bt_voice:
				if(attachmentType==0 || attachmentType==2){
					...
					final BuyDialog dialogToBuy = new BuyDialog(Throw_sspz.this, R.style.style_dialog_ballon, "确定");
					dialogToBuy.show();
					dialogToBuy.setContent(null, "已添加图片附件，是否移除该图片添加语音附件？");
					dialogToBuy.setOnSubmitClick(new OnClickListener() {
						...
						public void onClick(View v) {
							...
							uploadimgPath = "";
				       		...
				       		Intent intent = new Intent(Throw_sspz.this, AttachVoiceActivity.class);
							if(attachmentType==0){
								intent.putExtra("ifnewAttach", true);
							}else if(attachmentType==2){
								intent.putExtra("ifnewAttach", false);
...
//				rl_first.setVisibility(View.GONE);
//				if (mpDialog == null) {
//					mpDialog = new MyProgressDialog(Throw_sspz.this);
//				}
//				mpDialog.show();
...
//				showMsg("密封失败,请检查网络，或联系客服");
	...
	private void submitText(String str) {
		...
		jo.addProperty("bottleType", "4006");
