 ...
 *
 */
public class Throw_jfpz extends BaseActivity implements OnClickListener, OnGestureListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.throw_jfpz);
...
//					doSubmit();
			...
			case R.id.bt_pic:
				if(attachmentType==0 || attachmentType==1){
					...
					final BuyDialog dialogToBuy = new BuyDialog(Throw_jfpz.this, R.style.style_dialog_ballon, getResources().getString(R.string.confirm));
					dialogToBuy.show();
					...
					dialogToBuy.setOnSubmitClick(new OnClickListener() {
						...
						public void onClick(View v) {
							...
							uploadimgPath = "";
				       		...
				       		Intent intent = new Intent(Throw_jfpz.this, AttachVoiceActivity.class);
							if(attachmentType==0){
								intent.putExtra("ifnewAttach", true);
							}else if(attachmentType==2){
								intent.putExtra("ifnewAttach", false);
...
//		chuck_bottle_layout.startAnimation(set);
	...
	public void doSubmit(){
		...
		if(attachmentType==0){
			...
			sbumitAttachement(str,uploadimgPath);
		}
	}
	/**
	 * 上传文本和附件
	 ...
	 * @param path 附件路劲
	 */
	private void sbumitAttachement(String str, String path) {
...
//				rl_first.setVisibility(View.GONE);
//				if (mpDialog == null) {
//					mpDialog = new MyProgressDialog(Throw_jfpz.this);
//				}
//				mpDialog.show();
...
//				Toast.makeText(ThrowActivity.this, "成功", Toast.LENGTH_LONG).show();
...
//					showMsg("密封失败,请重试");
	...
	private void submitText(String str) {
		...
		jo.addProperty("useType", "0");
		jo.addProperty("bottleType", "4008");
		jo.addProperty("come", "6000");
		jo.addProperty("isShare", 1);
