...
public class CustomDialog {
	 ...
	 * @return
	 */
	public  android.app.Dialog showListDialog(Context context,String title,String[] items,final CustomDialogItemClickListener dialogItemClickListener){
	 ...
	 * @return
	 */
	public  android.app.Dialog showRadioDialog(Context context,String toast,final CustomDialogClickListener dialogClickListener){
	 ...
	 * @return
	 */
	public  android.app.Dialog showSelectDialog(Context context,String toast,final CustomDialogClickListener dialogClickListener){
	 ...
	 * @return
	 */
	public  android.app.Dialog showSelectDialog(Context context,String title,String toast,final CustomDialogClickListener dialogClickListener){
		return ShowDialog(context,title,toast,dialogClickListener,SELECT_DIALOG);
	}
	
	private  android.app.Dialog ShowDialog(Context context,String title,String toast,final CustomDialogClickListener dialogClickListener,int DialogType){ 
		if(context==null)
			return null;
		...
		if(TextUtils.isEmpty(title))	{
			((TextView)view.findViewById(R.id.point)).setVisibility(View.GONE);
		} else {
	...
	private  android.app.Dialog ShowDialog(Context context,String title,String[] items,final CustomDialogItemClickListener dialogClickListener){ 
		final android.app.Dialog dialog=new android.app.Dialog(context, R.style.DialogStyle);
		dialog.setCancelable(false);
