...
public class CustomPersonGridView extends GridView { 

	int vs;
	
	public CustomPersonGridView(Context context) { 
		super(context); 
	} 
	
	public CustomPersonGridView(Context context, AttributeSet attrs) { 
	super(context, attrs); 
