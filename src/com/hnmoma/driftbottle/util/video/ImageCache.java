...
public class ImageCache {
	...
	private void init(ImageCacheParams cacheParams) {
		...
		if (mCacheParams.memoryCacheEnabled) {
			if (BuildConfig.DEBUG) {
				MoMaLog.d(TAG, "Memory cache created (size = "
	...
	public BitmapDrawable getBitmapFromMemCache(String data) {
		...
		if (BuildConfig.DEBUG && memValue != null) {
			MoMaLog.d(TAG, "Memory cache hit");
		}
	...
	public void clearCache() {
		if (mMemoryCache != null) {
			...
			if (BuildConfig.DEBUG) {
				MoMaLog.d(TAG, "Memory cache cleared");
			}
		}
	...
	private static boolean canUseForInBitmap(Bitmap candidate,
		...
		if (!AndroidVersionsUtils.hasKitKat()) {
...
//		}
	...
	public static boolean isExternalStorageRemovable() {
		if (AndroidVersionsUtils.hasGingerbread()) {
	...
	public static File getExternalCacheDir(Context context) {
		if (AndroidVersionsUtils.hasFroyo()) {
